...
2026-07-15 — Hero headline period dropped («диво.»→«диво»); line break now explicit \n in locale strings (all 3)
2026-07-15 — Phone non-clickable + client-assembled (anti-index/scrape); number owner-corrected 638→633; removed from /terms requisites
...
2026-07-15 — PayPal SDK locale pinned to site locale (was buyer-auto → RU leak); uk uses en_US (uk_UA breaks hosted-buttons)
2026-07-15 — Contact requisites localized: address ru/en from /terms; en EDRPOU. ru «ЄДРПОУ» on /contact vs «ЕГРПОУ» /terms accepted
